 ...
 * from any parley client flows through this proxy's
 ...
 *
 * Storage: one small JSON map under the parley data home, same
...
/** Has the user manually named this chat (via any parley client)? */
