// Parley proxy — model capability + auxiliary-vision advertisement
...
export async function handleParleyAuxiliaryModels(
...
export async function handleParleyModelCapabilities(
