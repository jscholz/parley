...
export function MOCK_SETUP(mock) {
  ...
  mock.addChat(VIEWED_CHAT, {
    title: 'Viewed',
    messages: [{ role: 'user', content: 'seed', parley_id: 'umsg_rr_view_seed', timestamp: t0 }],
    lastActiveAt: Date.now() - 1000,
  });
  mock.addChat(APPROVAL_CHAT, {
    title: 'Approval source',
    messages: [{ role: 'user', content: 'seed', parley_id: 'umsg_rr_app_seed', timestamp: t0 }],
